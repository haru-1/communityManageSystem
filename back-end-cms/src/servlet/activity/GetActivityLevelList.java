...
@WebServlet("/activity/GetActivityLevelList")
public class GetActivityLevelList extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetActivityLevelList() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Activity> activity = activityDao.getActivityLevelForPage(page,act_level);
        //输出流
