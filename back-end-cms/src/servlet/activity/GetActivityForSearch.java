...
@WebServlet("/activity/GetActivityForSearch")
public class GetActivityForSearch extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetActivityForSearch() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Activity> activity = activityDao.getActivityForSearch(act_name,page);
        //输出流
