...
@WebServlet("/personal/getMyAssociation")
public class getMyAssociation extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public getMyAssociation() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Association> associations = personalDao.getMyAssociation(stu_id);
        //输出流
        ...
        if( associations.size() != 0) {
            ...
            result = new ResponseObject(500,"您没有参加过任何的活动");
        }
