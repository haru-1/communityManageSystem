...
@WebServlet("/personal/getPersonalMessage")
public class getPersonalMessage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Student student = personalDao.getPersonalMessage(stu_id);
        //输出流
        ...
        //登陆操作
        if( student != null) {
            result = new  ResponseObject(200,"查询成功!",student);
