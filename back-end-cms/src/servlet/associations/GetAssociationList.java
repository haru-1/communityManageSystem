...
@WebServlet("/associations/GetAssociationList")
public class GetAssociationList extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Association> association = associationDao.getAssociationForPage(page);
        //输出流
