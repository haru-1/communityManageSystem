...
@WebServlet("/apply/getAllApplyMessage")
public class getAllApplyMessage extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public getAllApplyMessage() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<ApplyMessage> applyMessages = applyDao.getAllApplyMessage(stu_id,as_name);
        //输出流
        ...
        if( applyMessages.size() != 0) {
            ...
            result = new ResponseObject(500,"您没有任何的社团申请审批");
        }
