 ...
 *
 */
@WebFilter(urlPatterns={"/login/*","/apply/*","/attend/*","/personal/*","/president/*","/admin/*"})
...
//		response.setHeader("Access-Control-Allow-Origin", "*");
		if(request.getRequestURI().endsWith("/login/Login")){
			//登陆接口不校验token，直接放行
			System.out.println("不校验token");
